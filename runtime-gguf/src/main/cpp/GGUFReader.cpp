...
Java_com_masterllm_runtime_gguf_GGUFReader_getGGUFContextNativeHandle(
	JNIEnv* env,
	jobject /*thiz*/,
	jstring modelPath
) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_masterllm_runtime_gguf_GGUFReader_getContextSize(
	JNIEnv* /*env*/,
	jobject /*thiz*/,
	jlong nativeHandle
) {
...
Java_com_masterllm_runtime_gguf_GGUFReader_getChatTemplate(
	JNIEnv* env,
	jobject /*thiz*/,
	jlong nativeHandle
) {
